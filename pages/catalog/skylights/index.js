    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Мансардные окна от лидеров производства. У нас вы можете купить мансардные окна от лидера производства из Европы, компании NICE WIN с доставкой по Москве и России"
                />
                <meta property="og:description" content="Мансардные окна от лидеров производства. У нас вы можете купить подкровельные мембраны от лидера производства из Европы, компании NICE WIN с доставкой по Москве и России" />
                <meta
                    name="keywords"
