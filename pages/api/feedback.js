                                                                        ...
                                                                        >
                                                                            <tbody>
                                                                                ...
                                                                                "
                                                                                    ...
                                                                                    "
                                                                                        >
                                                                                            <strong>Уже начали работать с вашим сообщением!</strong>
                                                                                        </h4>
                                                                                        <p
                                                                                            style="
                                                                                        font-size: inherit;
                                                                                    ...
                                                                                    "
                                                                                        >
                                                                                            <span>
                                                                                                Добрый день, ${name}! Мы получили ваше сообщение и уже скоро перезвоним вам с ответом!
                                                                                            </span>
                                                                                        </p>
                                                                                        <p
                                                                                            style="
                                                                                    ...
                                                                                    "
                                                                                        >
                                                                                            <span style="font-size: 16px;"><strong>Данные которые вы предоставили:</strong></span>
                                                                                        </p>
                                                                                        <p
                                                                                            style="
                                                                                        font-size: inherit;
