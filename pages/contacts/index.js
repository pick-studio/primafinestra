    ...
    return (
        <div className="contacts">
            ...
            <Head>
                ...
                <meta
                    name="description"
                    content="Помощь в подборе кровли для дома и мансардных окон. Мы готовы делиться своим опытом. У нас вы можете купить мансардные окна от лидера производства из Европы, компании NICE WIN с доставкой по Москве и России"
                />
                <meta property="og:description" content="Помощь в подборе кровли для дома и мансардных окон. Мы готовы делиться своим опытом. У нас вы можете купить мансардные окна от лидера производства из Европы, компании NICE WIN с доставкой по Москве и России" />
                <meta
                    name="keywords"
