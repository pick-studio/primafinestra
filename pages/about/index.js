  ...
  return (
    <div className="about">
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Огромный опыт работы в сфере строительства и кровли. Мы готовы делиться своим опытом. У нас вы можете купить мансардные окна от лидера производства из Европы, компании NICE WIN с доставкой по Москве и России"
        />
        <meta property="og:description" content="Огромный опыт работы в сфере строительства и кровли. Мы готовы делиться своим опытом. У нас вы можете купить мансардные окна от лидера производства из Европы, компании NICE WIN с доставкой по Москве и России" />
        <meta
          name="keywords"
